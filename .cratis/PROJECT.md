# Screenplay — project context

A business-oriented declarative language for specifying the desired
functionality of an information system. Includes the language, the compiler,
the VS Code extension (`cratis.screenplay`), and the specification model.
C#/.NET.

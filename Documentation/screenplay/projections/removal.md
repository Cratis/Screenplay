...
Removal allows you to delete projection instances when specific events occur. The language supports two types of removal: direct removal (`remove with`) and removal based on joined events (`remove via join`).

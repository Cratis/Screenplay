...
public class when_running_the_register_project_specifications : given.a_bound_register_project_plan
{
    ...
    void Because()
    {
        ...
        _success = runner.Run(_plan, _plan.Specifications.Values.Single(_ => _.ThenQueries.Length > 0).Id);
        _rejection = runner.Run(_plan, _plan.Specifications.Values.Single(_ => _.ThenErrors.Length > 0).Id);
    }

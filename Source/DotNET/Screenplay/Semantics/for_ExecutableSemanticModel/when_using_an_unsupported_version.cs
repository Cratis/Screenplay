...
public class when_using_an_unsupported_version : a_valid_semantic_model
{
    ...
    void Because()
    {
        ...
        _v2PairException = Catch.Exception(() => ExecutableSemanticModel.Create(LanguageVersion.V1, SemanticVersion.V2, _application));
        _unusedV2Exception = Catch.Exception(() => ExecutableSemanticModel.Create(LanguageVersion.V2, SemanticVersion.V2, _application));
    }
    ...
    [Fact] void should_reject_a_mixed_version_pair() => _v2PairException.ShouldBeOfExactType<InvalidSemanticContract>();
    [Fact] void should_not_select_v2_for_a_v1_model() => _unusedV2Exception.ShouldBeOfExactType<InvalidSemanticContract>();
}

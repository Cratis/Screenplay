...
public class when_listing_code_the_model_needs : given.a_semantic_binder
{
    ...
    [Fact] void should_preserve_play0268_for_remaining_unsupported_attachments() => (_result.Diagnostics.Count(value => value.Code == DiagnosticCodes.UnsupportedSemanticSyntax) >= 3).ShouldBeTrue();

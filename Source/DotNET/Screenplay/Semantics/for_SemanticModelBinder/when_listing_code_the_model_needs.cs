...
public class when_listing_code_the_model_needs : given.a_semantic_binder
{
    ...
    [Fact] void should_preserve_play0268_for_each_attachment() => (_result.Diagnostics.Count(value => value.Code == DiagnosticCodes.UnsupportedSemanticSyntax) >= 5).ShouldBeTrue();

...
// The inline event key comes first, as it does in Chronicle's ProjectionDefinitionSyntaxVisitor.ProcessFrom.
public class with_an_inline_key_and_a_from_block_key : given.a_semantic_binder
{
    const string Source =
        """
    ...
    [Fact] void should_key_the_transition_on_the_inline_key() => AffectedKey.Target.ShouldEqual(EventProperty("projectId"));

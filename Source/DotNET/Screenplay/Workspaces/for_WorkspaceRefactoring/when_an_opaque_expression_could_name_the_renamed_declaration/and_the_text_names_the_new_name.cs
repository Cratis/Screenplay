...
public class and_the_text_names_the_new_name : given.a_workspace_with_a_structured_value
{
    ...
    [Fact] void should_name_the_matched_name() => _result.Conflicts.Single().Message.Contains("names 'SalesChannel'", StringComparison.Ordinal).ShouldBeTrue();

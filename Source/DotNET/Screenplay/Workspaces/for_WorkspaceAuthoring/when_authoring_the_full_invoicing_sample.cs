...
public class when_authoring_the_full_invoicing_sample : Specification
{
    ...
    [Fact] void should_reject_the_showcases_undeclared_capture_events_in_safe_mode() => _workspace.ProposeAuthoring(_request with { ReferencePolicy = WorkspaceAuthoringReferencePolicy.Safe }).Accepted.ShouldBeFalse();
    [Fact] void should_disclose_the_undeclared_capture_event() => _result.AuthoringDiagnostics.Any(diagnostic => diagnostic.Message.Contains("InvoicePaidFromSent", StringComparison.Ordinal)).ShouldBeTrue();

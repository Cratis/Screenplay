...
public class and_a_line_is_not_a_trigger : given.a_compiler
{
    const string Source =
        """
        module Invoicing
    ...
    [Fact] void should_report_it() => _result.Diagnostics.Single().Code.ShouldEqual(DiagnosticCodes.InvalidReactionTrigger);

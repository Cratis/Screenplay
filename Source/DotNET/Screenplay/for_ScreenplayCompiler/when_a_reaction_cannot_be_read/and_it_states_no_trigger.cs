...
public class and_it_states_no_trigger : given.a_compiler
{
    const string Source =
        """
        module Invoicing
          feature Invoices
            slice Automation Reconcile
              reaction PaymentReconciler
                description "Nothing ever sets this off"
        """;
    ...
    [Fact] void should_report_it() => _result.Diagnostics.Single().Code.ShouldEqual(DiagnosticCodes.ReactionWithoutTrigger);

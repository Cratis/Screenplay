...
public class and_the_header_is_malformed : given.a_compiler
{
    const string Source =
        """
    ...
    [Fact] void should_report_it() => _result.Diagnostics.Single().Code.ShouldEqual(DiagnosticCodes.InvalidTriggerDeclaration);

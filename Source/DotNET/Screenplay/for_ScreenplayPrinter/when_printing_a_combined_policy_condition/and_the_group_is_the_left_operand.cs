...
public class and_the_group_is_the_left_operand : for_ScreenplayPrinter.given.a_printer
{
    ...
    const string Shape = "((role:InvoiceManager Or role:Accountant) And authenticated)";
    ...
    [Fact] void should_print_the_group() => _roundtrip.Printed.ShouldContain(@"require (role ""InvoiceManager"" or role ""Accountant"") and authenticated");

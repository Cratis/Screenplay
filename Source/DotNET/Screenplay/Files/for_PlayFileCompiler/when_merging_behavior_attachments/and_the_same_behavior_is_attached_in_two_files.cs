...
public class and_the_same_behavior_is_attached_in_two_files : when_compiling_a_folder.given.a_folder_of_play_files
{
    ...
    [Fact] void should_name_the_first_file() => _compilation.Result.Diagnostics.Single().Message.ShouldEqual($"Behavior 'Refreshing' is already attached to the module 'Alpha' in '{Path.Combine("Alpha", "Alpha.play")}' - both attachments run");
}

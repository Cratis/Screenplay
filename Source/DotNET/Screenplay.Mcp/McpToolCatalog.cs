...
static class McpToolCatalog
{
    ...
    [
        ...
        new("read-proposal", "Review paged change metadata, diagnostics, comments a changed document drops (view dropped-comments), or exact before/after base64 byte chunks by documentId. The proposal ID identifies an immutable complete plan.", ["proposalId"], ["proposalId", "view", "documentId", "offset", "limit"]),

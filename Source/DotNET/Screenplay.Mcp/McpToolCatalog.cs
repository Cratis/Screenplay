...
static class McpToolCatalog
{
    ...
    [
        ...
        new("read-workspace", "Page documents with root handles, semantic/event identities, source/executable diagnostics, or blocking implementation requirements from one immutable revision.", ["expectedRevision"], ["expectedRevision", "view", "offset", "limit"]),

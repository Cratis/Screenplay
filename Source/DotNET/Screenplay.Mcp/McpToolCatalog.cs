...
static class McpToolCatalog
{
    ...
    [
        ...
        new("read-workspace", "Page documents with root handles, semantic/event identities, compiler source-map entries (source-map view), source/executable diagnostics, or blocking implementation requirements from one immutable revision. An unavailable source map reports executable diagnostics.", ["expectedRevision"], ["expectedRevision", "view", "offset", "limit"]),

...
export const keywordDocs: Record<string, string> = {
    ...
    produces: 'Declares the events a command emits — single, multiple, or conditional — or an event a reactor trigger appends as a side effect.',
    executes: 'Declares a command a reactor trigger puts through the command pipeline.',
    ...
    observable: 'Marks a query as live — a subscription that pushes updates. An unmarked query is one-shot.',

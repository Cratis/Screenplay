...
export const keywordDocs: Record<string, string> = {
    ...
    reactor: 'Reacts to events and produces side effects. Lives inside Automation slices. A trigger with no body states intent on its own — `file`/code is optional realization metadata.',
